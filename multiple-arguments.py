...
''' 
    In the previous exercise, the square brackets around imag in the documentation showed us that the imag argument is optional. 
...
'''
#Instructions
    # I  - Use + to merge the contents of first and second into a new list: full

    # II - Call sorted() on full and specify the reverse argument to be True. Save the sorted list as full_sorted

    # III - Finish off by printing out full_sorted.
