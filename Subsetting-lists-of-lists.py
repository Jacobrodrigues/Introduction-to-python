...
""" results in a list, that you can subset again by adding additional square brackets.
    ...
    is already defined for you in the workspace. You can experiment with it in the IPython Shell.
"""

# result from the answer
# x= [["hallway", 11.25],["kitchen", 18.0], ["living room", 20.0], ["bedroom", 10.75], ["bathroom", 9.50]]
# print(house[-1][1])